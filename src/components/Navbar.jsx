...
const Navbar = () => {
    ...
    const handleLogout = () => {
        ...
        localStorage.removeItem('addresses'); // Optional: clear addresses too or keep them? Keeping for now logic-wise, but maybe safer to clear. User didn't specify. I'll clear user only.
        setUser(null);
        navigate('/');
    };
        ...
        <nav className="fixed top-0 left-0 w-full bg-white shadow-sm z-50 font-sans text-sm tracking-wide">
            ...
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex gap-8 items-center font-bold text-gray-700">
                    <Link to="/home" className="hover:text-primary transition uppercase text-xs">Home</Link>
                ...
                <div className="flex gap-5 items-center text-gray-700">
                    <button className="hover:text-primary transition" title="Search">
                    ...
                    {user ? (
                        // Logout Icon
                        <button onClick={handleLogout} className="hover:text-red-600 transition" title="Logout">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                            </svg>
                        </button>
                    ) : (
                        <Link to="/login" className="hover:text-primary transition" title="Login">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button onClick={toggleCart} className="relative hover:text-primary transition" title="Cart">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
